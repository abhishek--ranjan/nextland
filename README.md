...
NextLand Society CMS is an open-source, modular, and extensible content management system for residential societies, gated communities, and apartment complexes. It provides a structured platform for governance, communication, documentation, and community engagement, built with modern web technologies and an API-first architecture.
...
- Replace storage layer with a database if needed
...
## 🔒 Security
If you discover a security vulnerability, do not open a public issue. Please report it responsibly via the instructions in `SECURITY.md`.
